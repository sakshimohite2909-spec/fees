      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-purple-200/80 shadow-sm glass-panel-glow card-attractive-hover">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-purple-100">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-purple-700 via-pink-600 to-purple-700 hover:from-purple-800 hover:to-pink-700 text-white font-extrabold text-xs shadow-md shadow-purple-600/20 transition-all cursor-pointer transform hover:-translate-y-0.5"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-purple-100 via-pink-100 to-purple-100 hover:from-purple-200 hover:to-pink-200 text-purple-950 font-extrabold text-xs border-2 border-purple-300 shadow-2xs transition-all cursor-pointer"
                >
            ...
            {/* 📥 Download Student Fee Excel Report Button Below Table/Chart */}
            <div className="mt-5 pt-4 border-t border-purple-100 flex flex-col sm:flex-row items-center justify-between gap-3">
              <p className="text-xs text-slate-500 font-medium">
                Showing <span className="font-bold text-slate-900">{filteredStudents.length}</span> student records
              </p>
              <button
                onClick={handleExportToExcel}
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3 rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:from-emerald-700 hover:to-teal-800 text-white font-extrabold text-xs shadow-md shadow-emerald-600/20 transition-all cursor-pointer transform hover:-translate-y-0.5"
              >
                <Download className="w-4 h-4 text-white" />
                <span>Download Student Fee Excel Report (.xlsx)</span>
              </button>
            </div>
