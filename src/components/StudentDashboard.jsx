    ...
    <div className="space-y-8 animate-slide-up">
      ...
      {step === 'dashboard' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="card-interactive p-6 animate-fadeIn">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold text-slate-700 hover:text-indigo-600 hover:bg-indigo-50/50 rounded-xl transition-all border border-slate-200 hover:border-indigo-300 cursor-pointer"
              >
            ...
            {/* Profile Grid */}
            <div className="mt-4 p-4 bg-slate-50/80 rounded-xl border border-slate-200/80 grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-xs font-bold text-slate-900">{selectedCourse} - <span className="text-indigo-600">{selectedBranch}</span></p>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-slate-900">Fee Structure & Payments</h3>
                <p className="text-xs text-slate-500 font-medium">Exam Fee & Tuition Fee for session {feesConfig.academicYear || '2026-2027'}</p>
              </div>
              <div className="flex items-center gap-1.5 bg-indigo-50/70 text-indigo-700 border border-indigo-100 px-3 py-1 rounded-full text-xs font-semibold">
